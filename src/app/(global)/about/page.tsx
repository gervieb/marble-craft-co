        ...
        <Grid container flexDirection="row" mt={4} mb={10}>
          ...
          <Grid item xs>
            <Typography sx={{ alignItems: 'center' }}>
              ...
              <br />
              <br />
              My father, inspired by his own father&apos;s passion, decided to
              build on this artistic foundation and elevate it to a family
              business. Under his skilled hands, the focus shifted from small
              figurines to larger, more functional pieces. The belief that
              marble could be both classy and functional became our guiding
              principle.
              <br />
              <br />
              The transition from generation to generation marked a journey of
              evolution. My father explored the versatility of marble,
              discovering that it wasn&apos;t just a medium for artistry but
              could also serve practical purposes. He envisioned a range of home
              decor items that not only exuded class but also served a purpose
              in daily life.
              <br />
              <br />
              ...
              each piece told the story of our family&apos;s commitment to
              blending elegance with utility.
              <br />
              <br />
              As the business flourished, it became a testament to the enduring
              value of tradition and craftsmanship. Our family&apos;s dedication
              to creating marble pieces that were not just beautiful but also
              ...
              legacy of my grandfather and father. Our family&apos;s journey
              from small figurines to a thriving business is a story of
              innovation, dedication, and the belief that marble, with its
              timeless appeal, can seamlessly blend class with functionality.
              Each piece we create is a nod to our heritage, a tribute to the
              idea that from stone, we can fashion something enduring,
